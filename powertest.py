...
class ball_5():
    ...
    def draw(self):
        screen.blit(pygame.image.load('assets/ball.png').convert_alpha(),(self.rect.x,self.rect.y))
...
class paddle():
    ...
    def draw(self):
        screen.blit(pygame.image.load('assets/paddle_purple.png').convert_alpha(),(self.rect.x, self.rect.y))
...
class powerup_5ball():
    ...
    def draw(self):
        ...
        while c<5:
            c+=1
            screen.blit(pygame.image.load('assets/fireball.png').convert_alpha(),(self.rect.x,self.rect.y))
...
fireball = powerup_5ball(50+player_paddle.x + (player_paddle.width//2), player_paddle.y - player_paddle.height)
t=0
for i in range (4):
    t+=1
    ball_5(t*5+20+player_paddle.x + (player_paddle.width//2), player_paddle.y - player_paddle.height)
run = True
while run:
    ...
    for event in pygame.event.get():
        if event.type==pygame.KEYDOWN and event.key==pygame.K_SPACE and live_ball==False:
            ...
            fireball.reset(50+player_paddle.x + (player_paddle.width // 2), player_paddle.y - player_paddle.height)
            player_paddle.reset()
            wall.create_wall()           
