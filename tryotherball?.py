try:
    ...
    print ("%% Failed to Load Module: %s" % (__file__, err))
    sys.exit(1)
class Paddle(pygame.sprite.Sprite):
    ...
    def __init__(self, xy):
        ...
        # set image and rect
        self.image = pygame.image.load(os.path.join('assets', 'ball2.png'))
...
class SolidBlock(pygame.sprite.Sprite):
    ...
    def __init__(self, xy):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load(os.path.join('assets', 'grey.png'))
        self.rect = self.image.get_rect()
...
class BlockFactory(object):
    ...
    def __init__(self):
        ...
        self.images = {
            1: pygame.image.load(os.path.join('assets','blue.jpeg')),
            2: pygame.image.load(os.path.join('assets','green.jpg')),
            3: pygame.image.load(os.path.join('assets','red.jpeg')),
            4: pygame.image.load(os.path.join('assets','orange.jpeg')),
            5: pygame.image.load(os.path.join('assets','purple.jpeg'))
        }
...
class Game(object):
    ...
    def __init__(self):
        ...
        # make background
        self.background = pygame.image.load(os.path.join('assets', 'ball2.png'))
